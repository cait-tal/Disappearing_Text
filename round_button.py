...
class RoundedButton(tk.Canvas):
    ...
    def __init__(self, master=None, text: str = "", radius=25, btnforeground="#000000", btnbackground="#ffffff",
        ...
        self.config(bg=self.master["bg"], borderwidth=0, highlightthickness=0)
        ...
        self.text = self.create_text(0, 0, text=text, tags="button", fill=btnforeground, font=("Verdana", 20, "normal"),
                                     justify="center")
    ...
    def resize(self, event):
        ...
        self.round_rectangle(5, 5, width - 140, height - 190, radius, update=True)
    ...
    def border(self, event):
        if event.type == "4":
            self.itemconfig(self.rect, fill=self.btnforeground)
